...
const addFavoriteProduct = catchAsync(async (req, res, next) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(favorite, "Product successfully added in favorite"));
});
...
const deleteProductFromFavorite = catchAsync(async (req, res, next) => {
  ...
  res
    .status(200)
    .json(
      new ApiResponse(favorite, "Product successfully remove from favorite")
    );
});
const checkProductInFavoriteList = catchAsync(async (req, res, next) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(favorite, "Product successfully found in favorite"));
});
